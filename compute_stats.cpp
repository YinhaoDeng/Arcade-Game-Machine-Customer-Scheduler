...
class Customer  // read in customers
{
public:
    int priority;
    int arrival_time;
    ...
    Customer(int par_priority, int par_arrival_time, int par_slots_remaining) // initialise customers
    {
...
class Stats
{
    ...
    int total_wait; // for all customers = high q customers + low q customers
...
Stats::Stats()  // create an instance or stats class
{
    total_wait_0 = -1;
    total_wait_1 = -1;
    total_wait = -1;
